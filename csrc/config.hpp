...
struct LowLatencyLayout {
    ...
    LowLatencyLayout(void* rdma_buffer, int num_max_dispatch_tokens_per_rank, int hidden, int num_ranks, int num_experts) {
        ...
        send_buffer_bytes = align_up<size_t>(send_buffer_bytes, NUM_BUFFER_ALIGNMENT_BYTES);
        ...
        recv_buffer_bytes = align_up<size_t>(recv_buffer_bytes, NUM_BUFFER_ALIGNMENT_BYTES);
